...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of Wazn birth 2019-11-09 10:49:53
    var waznBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    var secondsPerBlock;
    // before Wazn's birth
    if (requestedTime < waznBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < waznBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > waznBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - waznBirthTime)/secondsPerBlockV1);
