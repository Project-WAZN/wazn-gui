...
<context>
    ...
    <message>
        ...
        <translation>Це полегшує надсилання та отримання Wazn і знижує кількість помилок при введенні адрес вручну.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>УВАГА: Копіювання вашої мнемонічної фрази в буфер обміну може супроводжуватися перехопленням цих даних різним шкідливим програмним забезпеченням, яке відправить вашу мнемоніку зловмисникові, після чого ваші Wazn можуть бути вкрадені. Будь ласка, введіть вашу мнемонічну фразу вручну з клавіатури.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Wazn. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнінг на вашому комп&apos;ютері допомагає зміцнити мережу Wazn. Чим більше людей майнять, тим важче атакувати мережу, кожний може допомогти.

Майнінг також дає маленький шанс отримати Wazn. Ваш комп&apos;ютер буде створювати хеші в пошуку вирішення блоку. Якщо ви знайдете блок, то получите винагороду! Щасти!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу Wazn (наприклад: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щоб мати можливість обмінюватися даними з мережею Wazn, ваш гаманець повинен бути підключений до ноди Wazn. Для кращої конфіденційності рекомендується запустити свою власну ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Окрім цього, ви можете вказати ноду швидкого завантаження, щоб негайно почати користуватися Wazn.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Виберіть цю опцію, якщо ви вперше користуєтесь Wazn.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Тимчасове використання віддалених нод зручно для негайного використання Wazn (звідси назва &quot;початкове завантаження&quot;), однак пам&apos;ятайте, що при використанні віддалених нод (включаючи вибір початкового завантаження), ноди можуть відстежувати вашу IP адресу, відстежувати вашу &quot;висоту відновлення&quot; і відповідні дані запиту блоку, і відправляти вам неточну інформацію, щоб дізнатися більше про здійснені вами транзакції.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Цей режим ідеально підходить для управління невеликими сумами Wazn. У вас є доступ до основних функцій для здійснення транзакцій та управління ними. Програма автоматично підключиться до мережі Wazn, щоб ви відразу могли почати використовувати Wazn.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Щоб мати можливість обмінюватися даними з мережею Wazn, ваш гаманець повинен бути підключений до ноди Wazn. Для кращої конфіденційності рекомендується запустити свою власну ноду.
