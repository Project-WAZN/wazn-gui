...
<context>
    ...
    <message>
        ...
        <translation>这会使发送或接收Wazn更加简单，并且减少在手动输入地址时发生的错误。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告：复制种子单词到剪贴板，可能会暴露给恶意软件，导致你的种子单词被记录，从而Wazn被盗。请手工抄写下这些种子单词。</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Wazn. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>挖矿有助于增强Wazn网络。挖矿的人越多，攻击网络就会越困难，一点一滴的算力亦有帮助。

挖矿的同时也给予一点小概率的Wazn作为收益回报。你的电脑将产生许多哈希值，来寻找打包区块的答案。如果你成功找到一个区块，将会得到相关的奖励。祝你好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了掩盖Wazn交易中任何付款的去向，第三方不应知道环签名中每个输入和输出的对应关系。否则就会削弱环签名提供的保护作用。如果仅有一个输入之外的所有输入都已知，那么所有付款的去向将变得透明，这将使作为门罗币三个主要隐私保护层之一的环签名彻底无效。&lt;br&gt; 为帮助交易中避免出现这些问题，可以使用已知去向交易清单来避免在新交易中使用它们。这个清单由门罗币项目维护，可在 wazn.io 网站上找到，您可以在此处导入此清单。 &lt;br&gt; 或者您可以自己扫描区块链 （以及复制了门罗币密钥的克隆钱包的区块链），使用wazn-blockchain-mark-spent-outputs 工具创建已知的已用输出清单。 &lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>输入Wazn地址 (例如: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>请访问wazn.io了解详情</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>为了能够与Wazn网络通信，您的钱包需要连接到一个Wazn节点。为了最好的隐私，建议运行您自己的节点。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>除此之外，你还可以指定一个引导节点来快速的使用Wazn。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>如果这是您第一次使用Wazn，请选择此选项。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>连接您的硬件钱包，以创建一个新Wazn钱包。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>该模式非常适合管理少量的Wazn。您可以访问用于创建和管理交易的基本功能。它会自动连接到Wazn网络，所以您可以立即开始使用Wazn。</translation>
    </message>
    <message>
