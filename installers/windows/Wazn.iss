; Wazn Pollination GUI Wallet Installer for Windows
; Copyright (c) 2019-2021 WAZN Project</p>
; Copyright (c) 2017-2020, The Monero Project
; See LICENSE
#define GuiVersion GetFileVersion("bin\wazn-wallet-gui.exe")
...
DefaultDirName={commonpf}\Wazn GUI Wallet
...
Source: "bin\wazn-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; Wazn CLI wallet
Source: "bin\extras\wazn-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Wazn wallet RPC interface implementation
Source: "bin\extras\wazn-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "bin\extras\wazn-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wazn-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\bitwazn');
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\wazn-project\wazn-core', 'blockchainDataDir', blockChainDir);
...
begin
  Result := BlockChainDir('') + '\bitwazn.log';
...
Name: "{group}\GUI Wallet"; Filename: "{app}\wazn-wallet-gui.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\wazn-gui-wallet-guide.pdf"; IconFilename: "{app}\wazn-wallet-gui.exe"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\wazn-wallet-gui\wazn-wallet-gui.log"""
...
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\wazn-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\wazn-project"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\wazn-project\wazn-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\wazn-project\wazn-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};

; Configure a custom URI scheme: Links starting with "wazn:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily start payments; example URI: "wazn://<address>?tx_amount=5.0"
Root: HKCR; Subkey: "wazn"; ValueType: "string"; ValueData: "URL:Wazn Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "wazn"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "wazn\DefaultIcon"; ValueType: "string"; ValueData: "{app}\wazn-wallet-gui.exe,0"
Root: HKCR; Subkey: "wazn\shell\open\command"; ValueType: "string"; ValueData: """{app}\wazn-wallet-gui.exe"" ""%1"""

; Configure a custom URI scheme: Links starting with "waznseed:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily hand over custom seed node info to the wallet, with an URI of the form "waznseed://a.b.c.d:port"
Root: HKCR; Subkey: "waznseed"; ValueType: "string"; ValueData: "URL:Wazn Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "waznseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "waznseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\wazn-wallet-gui.exe,0"
Root: HKCR; Subkey: "waznseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\wazn-wallet-gui.exe"" ""%1"""
